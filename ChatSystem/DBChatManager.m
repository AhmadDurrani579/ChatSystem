...
-(void)sendAndSaveMeesage : (id)message andMessageType:(NSString *)messageType roasterLoadUser :(MOModelUser *)roasterLoadUser  ofThread:(Chat *)thread  withCompletionHandler:(void (^)(Chat *soMessage, BOOL success))handler
{
...
//    loginResponse *obj = (loginResponse *) [defaults rm_customObjectForKey:@"UserData"];
    NSString *myJID ;
    myJID =  roasterLoadUser.jabberId ;
    ...
    NSString *myString = [defaults stringForKey:@"jID"];
        ...
        senderName  =   [NSXMLElement elementWithName:@"sender_name" stringValue: roasterLoadUser.name];
        NSString *idOfUsers = @"ahmed_21" ;
        senderID    =   [NSXMLElement elementWithName:@"sender_id" stringValue:idOfUsers];
         ...
         thread.from_Jabber = jid.full ;
         thread.to_Jabber = myString ;
         thread.message = message ;
         thread.messageType = @"1" ;
         thread.is_Mine = true ;
...
//    [xmppRoom joinRoomUsingNickname:@"keithoys" history:nil];
    ...
    [xmppStream setHostName:@"service61.secureother.com"];
...
//    NSString *myJID         = [NSString stringWithFormat:@"%@@opchat.ibexglobal.com", obj.loginUserID];
    NSString *myJID = @"ahmed_1@service61.secureother.com" ;
//    anupam@service61.secureother.com
...
//    NSString *myJID           = [NSString stringWithFormat:@"%@@ibexglobal.com", obj.loginUserID]; // local pass
    ...
    [defaultss setObject:[jid full] forKey:@"jID"];
...
//                }
                ...
                [[NSNotificationCenter defaultCenter]
                    postNotificationName:@"ChatMessageReceived"
                    object:_userChat];

//                [NotifCentre postNotificationName:@"ChatMessageReceived" object:_userChat];
